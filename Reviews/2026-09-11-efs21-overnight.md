...
- **The cheap prototype need not stay limited to three simple validators:** the [[2026-09-12-efs21-canonical-native-types-plan|independently reviewed canonical EFS Types bridge plan]] reuses the actual structural interpreter, first through a tested registry and then through Files. IDs, encodings and qualification need explicit changes; full admission, reference support and arbitrary developer validation are not implied. This bridge is not implemented or priced yet.
