...
- **The canonical-Type registry now works:** the [[2026-09-12-efs21-canonical-native-types-results|reviewed direct registry gate]] reuses the actual structural interpreter under ordinary deployment limits. Ninety signed local transactions and actual compiled caches cover valid data and refusals; a direct uint256 validation costs97,288gas. Files/SDK integration and whole-operation pricing remain next. Full admission, reference support and arbitrary developer validation are not implied.
...
**Current engineering gate:** the [[2026-09-12-efs21-body-copy-plan|bounded validation-copy experiment]] is complete at`ebc7d54`, independently reviewed, root-reproduced and pushed. The [[2026-09-12-efs21-posting-store-plan|full-model mandatory index-contract extraction]] is stopped at a real deployment-size boundary: the final bounded variant is24,761bytes,185over the unchanged cap. Five exact source/artifact probes are preserved; no paid index-saving claim follows. The [[2026-09-12-efs21-canonical-native-types-results|canonical registry/helper Task1]] is now independently reviewed and root-reproduced at source/support`6d1afce`; Task2 integrates Files/SDK/Discovery and pairs whole operations. It tests whether useful strong structural types can be retained in the cheaper contract-owned filesystem; no default/profile adoption is implied.
