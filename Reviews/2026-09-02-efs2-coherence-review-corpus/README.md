...
> **2026-09-10 documentation consolidation:** retained September 2 review
> corpus index, brought onto main from committed source `aae282df72f214d791963aeac1cf3c38d162c56e`.
> The [full lane corpus and findings ledger](https://github.com/efs-project/planning/tree/aae282df72f214d791963aeac1cf3c38d162c56e/Reviews/2026-09-02-efs2-coherence-review-corpus)
> remain at that exact source; this main folder contains the index only.
> Read the [errata](../2026-09-02-efs2-coherence-and-mvp-readiness-review-errata.md)
> and current [Core design spine](../../Designs/efsv2/README.md) before using
> these historical findings. This import is not a new validation run.
...
- **Verification is not uniform.** Only the 27 clusters the lanes rated blocking were adversarially verified, by two lenses each. Nothing was refuted on its text; 21 came back confirmed-with-correction, 5 survived as blocking, 21 were downgraded, and 1 was dropped as already dispositioned and immaterial. The materiality lens was deliberately instructed to downgrade wherever "blocking" overstated the case, so its severities are a floor rather than a neutral estimate. Treat an unverified row's citation as a pointer to check before acting on it.
