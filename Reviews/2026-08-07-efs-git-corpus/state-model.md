...
The genesis object (an ordinary DATA record, body = canonical CBOR per the client-side encoding rules):
...
repoId = the DATA id of this object (owner+salt derivation, unchanged kernel math)
```
