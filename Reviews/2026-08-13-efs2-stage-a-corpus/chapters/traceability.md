...
| C-TX-3 | History append-only; authenticated pre-withdrawal/withdrawal/revocation/tombstone/replacement never erase bytes or resurrect older values | [DERIVED INVARIANT — const.] | bind §3.4/§4; auth §2.2/§3.2–3.3 bounded TargetRecordCommitment evidence + Admission-only lifecycle context; idx §2.3/§3 RAW_AUDIT sequential journal | GV-9, GV-18 | CV-WITHDRAW; CV-PREWITHDRAW/T4-MAX-BODY; CV-SHADOW; FX-EAP.C, FX-NANDA.D | KA-12 | COVERED |
