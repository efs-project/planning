...
| C-IX-4 | Paginated typed backlinks by role/target; hot values, spam, dead history never turn point reads or locator selection into unbounded scans | [DERIVED INVARIANT — const.; owner ruling item A] | idx §3.5/§5.1a/§7/§8; every B0 selector posting visited consumes the cap and returns a cursor validated against its exact family-specific context tag plus separate basis ordinal honestly | GV-14 (first/middle/end; wrong-context and corruption rejection; unique outer/inner continuation) | WL-SPRAY, WL-HOT, WL-CHURN, WL-DEAD-LOCATOR | CF-5; dead-spray total-visit bound | COVERED |
