...
| V2-E3 Record/context bakeoff | Cells B0/F1/F5/X17 with declared confounds; every k=1..64 frozen and measured under exact one-tx B0/F1 units, no adaptive refinement; F1 aggregator overhead explicit; FRESH_5/REENDORSE_5 plus explicitly derived DERIVED_FSTAR_5; frozen-corpus discipline | bk §3–§4, §6; hf §3.1–§3.4, FR-1..6 |
...
- **Measurement-evidence contract** (hf §3.1–§3.4): every claimed output has a
  frozen result schema/digest, typed error, cross-implementation equality, and
