...
| C-IX-4 | Paginated typed backlinks by role/target; hot values, spam, dead history never turn point reads or locator selection into unbounded scans | [DERIVED INVARIANT — const.; owner ruling item A] | idx §0.1/§3.5/§5.1a/§7/§8; every B0 selector posting visited consumes the cap; one nonzero trusted Principal is context-bound and differently authored postings are skipped before scoring; all continuation grammar is byte-committed in the profile | GV-14 (first/middle/end; Principal/query/context corruption rejection; unique outer/inner continuation) | WL-SPRAY, WL-HOT, WL-CHURN, WL-DEAD-LOCATOR | CF-5; dead/untrusted-spray total-visit bound | COVERED |
