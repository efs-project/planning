...
- Oracle methods are transport-free and deterministic. Probe results are complete ABI byte strings; no wildcard, mask, only-count, or reported-boolean substitute. Use BigInt for chain quantities; persist decimal strings.
