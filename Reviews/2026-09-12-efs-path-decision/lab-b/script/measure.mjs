...
const paidSliceCell = {
  ...
  body: async (ctx, a, plan) => {
    ...
    const expectA = { subject: subj, expectedHead: a2, selectedAuthor: A, selectedProofKind: 2, pairId, itemA, itemB, mantissa: J.mantissaA2, scale: J.scale, observedAt: J.observedAt, noteCommitment: NOTE_COMMITMENT, basisAdmission: basis, expectedRevision: 2 }; // expectedHead / expectedRevision are sealed fixture inputs for QUOTE_A2 / A2; observedAt / noteCommitment are J.* (this runner's candidate-side mirror)
    const expectB = { ...expectA, expectedHead: b1, selectedAuthor: B, selectedProofKind: 1, mantissa: J.mantissaB1, expectedRevision: 1 }; // QUOTE_B1 / B1
