...
const record = { startedAt: new Date().toISOString(), source: pins.source, oracle: pins.oracle, lease: { start, latest, end }, pins, resources: disk(), anvilVersion: execFileSync('/Users/james/.foundry/bin/anvil', ['--version'], { encoding: 'utf8' }).trim() };
...
let node;
try {
  node = spawnOwned('/Users/james/.foundry/bin/anvil', anvilArgs, 'anvil.log');
