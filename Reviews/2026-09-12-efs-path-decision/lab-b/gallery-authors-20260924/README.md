...
**Status:** Disposable local evidence, not a protocol, public-RPC, or mainnet feasibility claim. The intended 1,000-File cell was **not run**: the measured 100→250 Node RSS trend crossed the predeclared 768 MiB stop/go projection. The hard cap was never exceeded.
