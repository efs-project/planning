...
| 2. Full required index bundle and evolution | [[core-closeout-index-plan-20260915|Task1 implementation]] in progress from revieweddcb9b2f. | Complete manifest, generic role/target references without duplicate Files appends, declaration semantics, populated replay/catch-up/cutover, joint costs. |
