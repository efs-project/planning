...
**Spec:** [[2026-09-11-efs21-full-model-storage-preflight]], [[2026-09-11-efs21-overnight]]. Three-site source preflight independently reviewed at exact`ab13d89e4e6111efc5eea6fc61c3ac56181c9a70`. **Not dispatched.** Complete and independently gate the active Envelope-only task first; root then pins its clean head and confirms Record storage/these three logical decisions are unchanged. This plan precedes any shared-Record-slab or dictionary packing if selected; do not transplant its storage-byte checks to a different Record backend.
