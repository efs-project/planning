...
**Status:** historical commit-ready disposable consumer evidence; no protocol, product API, deployment, production, durability, or freeze claim
...
`df0ddd3`](https://github.com/efs-project/planning/tree/df0ddd3b77fad7dae4e84c3cde6b009d703cc0cb/Reviews/2026-08-25-data-explorer-exp-c0-consumption).
...
The exact committed Core bytes in the source packet's `inputs/` are its only
inputs; that directory is retained at the pinned source, not imported here:
...
## Files retained at the exact source

[Open the preserved packet tree](https://github.com/efs-project/planning/tree/df0ddd3b77fad7dae4e84c3cde6b009d703cc0cb/Reviews/2026-08-25-data-explorer-exp-c0-consumption).
The following are source-tree paths, not files installed beside this README:
...
Historical reproduction commands below apply only to an explicitly authorized
checkout of the exact source commit containing the code/fixtures, not this
Markdown-only main checkout. No reproduction is requested by consolidation:
