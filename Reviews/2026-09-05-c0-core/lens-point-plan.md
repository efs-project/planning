...
- [x] **Step 1: Write red grammar and semantic tests.** Read the complete B0 chapter, including all T1–T10 transitions. Start with a missing `LensPlan` import or missing deployed method and run a targeted test to establish red. Encode the canonical body independently, for example:
