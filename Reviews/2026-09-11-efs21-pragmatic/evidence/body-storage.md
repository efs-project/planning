...
The **primary comparison is arm 2 versus arm 3**. Arm 1 versus arm 2 exposes defense cost; arm 1 versus arm 3 is the total deployable change. The JSON retains all three deltas. Both safety-matched arms check exact returned identity; the code-backed arm additionally checks its different physical representation.
