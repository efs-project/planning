...
The PM named the seams where trouble was expected. They were right about where, and mostly wrong about severity: eight are strained, one is broken, none is conceptually incoherent.
...
| `main` × the unmerged branches | strained | The branches are internally coherent and source-locked to each other | `main` does not describe the project. See §2 |
