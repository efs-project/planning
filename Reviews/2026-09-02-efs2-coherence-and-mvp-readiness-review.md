...
**Corpus:** [`2026-09-02-efs2-coherence-review-corpus/`](./2026-09-02-efs2-coherence-review-corpus/README.md) — every lane map, seam report, judgement, and the [findings ledger](https://github.com/efs-project/planning/blob/aae282df72f214d791963aeac1cf3c38d162c56e/Reviews/2026-09-02-efs2-coherence-review-corpus/findings-ledger.md)
...
> **2026-09-10 visibility note:** this is the retained September 2/3 report,
> not a current status update. Read the
> [errata](./2026-09-02-efs2-coherence-and-mvp-readiness-review-errata.md),
> [consolidation map](./2026-09-10-design-consolidation.md), and current
> [Core spine](../Designs/efsv2/README.md). Design visibility and prototype
> progress have changed since the reviewed checkpoint.
...
The full ledger with per-finding verification verdicts, evidence, and source lanes is in the corpus: [`findings-ledger.md`](https://github.com/efs-project/planning/blob/aae282df72f214d791963aeac1cf3c38d162c56e/Reviews/2026-09-02-efs2-coherence-review-corpus/findings-ledger.md). The classes the PM asked for are kept strictly separate there, because they need different repairs:
...
| S11 | **The genesis manifest**: who mints the first Realm, which Types it admits and in what order, which index kinds are live at genesis, and who creates the root Directory, Mount and Route | efsv2 with the Stage B lead; James only for the Realm choice | `efsv2` (no document owns this today) | Verification promoted this to a hard blocker. Nothing on `main` or on any branch says it; the one executed trace assumes the fixture already has a root, so the first real write has no defined starting state |
