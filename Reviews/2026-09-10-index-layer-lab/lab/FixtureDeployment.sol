...
// LAB COPY (index-layer lab, round 2) of Reviews/2026-09-08-upgradeable-foundation/test/FixtureDeployment.sol
// with the three "../src/" imports rewritten to the lab's "Foundation/" remapping. Nothing else changed.
import {StateKernel} from "C0Core/StateKernel.sol";
import {UpgradeStorage, FixtureEndpoint} from "Foundation/UpgradeStorage.sol";
import {UpgradeableFixtureCore} from "Foundation/UpgradeableFixtureCore.sol";
import {UpgradeableFixtureCarrier} from "Foundation/UpgradeableFixtureCarrier.sol";
import {
