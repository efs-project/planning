...
contract UpgradeableFixtureCore is FixtureEndpoint {
    ...
    ) external virtual returns (StateKernel.AdmitResult memory r) {
        // LAB EDIT (index-layer lab): `virtual` added so the U4 core can retire
        // this un-hooked operator path. Nothing else in this file is changed.
