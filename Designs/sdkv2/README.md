...
| **Instantiated product coordination input** | Data Explorer is an independent general-purpose typed-data product, not a File Browser panel. The initial input at `08bb5f2906191f0d87624d9a6ecc6788a8b2754d` is historical; [[../data-explorer/README]] now routes the reconciled main-visible corpus. It remains `#status/draft` and does not freeze SDK or protocol mechanisms. |
...
| [[mvp-interface]] | Retained September five-seam MVP-C0 consumer contract; reconciled alongside, not in place of, the newer integration-pressure direction |
