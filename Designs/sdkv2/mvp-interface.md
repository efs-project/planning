...
> **Consolidated onto main (2026-09-10):** this retained September MVP-C0
> interface is a disposable consumer contract. The newer [[README|SDK spine]]
> and [[files-integration-pressure]] govern current SDK design direction;
> neither this import nor the prototype tests freeze a public SDK API.
