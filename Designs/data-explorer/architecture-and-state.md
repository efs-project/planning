...
### August `EXP-C0/v0` trace-bound result law — historical profile

The August disposable Core control contributed one non-public input contract:
...
The August proposal used the following presentation vocabulary. These names
are not September's point-result enum or a current SDK API:
