...
**Last reconciled:** 2026-09-10 — September routing caveat; original August evidence inventory retained
...
> **Decide now: nothing.** The August product/package, published-view,
> extension and Explorer-write questions below remain evidence-gated future
> Explorer questions, not blockers or scope additions for File Browser MVP0.
> The September contraction and current SDK boundary apply first. Historical
> delegation is not renewed authority to run experiments or implement products
> during this documents-only consolidation.

## Consolidation boundary — 2026-09-10

This document is preserved from `codex/data-explorer-pm` at
[`df0ddd3`](https://github.com/efs-project/planning/tree/df0ddd3b77fad7dae4e84c3cde6b009d703cc0cb/Designs/data-explorer).
Its original August dates, hypotheses, candidate vocabulary and evidence gates
remain historical design input, not a current implementation instruction.
The [[Designs/data-explorer/README#Current routing and scope — 2026-09-10|current routing block]]
and [[Reviews/2026-09-04-explorer-mvp-convergence/README|September reconciliation]]
qualify that input: File Browser is the first thin guest/write journey and must
work with Explorer absent; Explorer is a separate typed-data workspace outside
the MVP0 packaging gate. The shared SDK owns read, result, action and independent
read-back semantics. August `ResultV0`, split Type/query controls and experiment
labels are not substituted into September's operation-specific interfaces.
Broader views, saved-view publication, extensions and Explorer writes remain
proposals behind their applicable gates. No experiment was rerun, evidence
upgraded, prototype moved, or implementation authorized by this consolidation.
...
### DATA-E4 — future Explorer write-capable label
