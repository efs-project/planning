...
**James, before the away window (~Aug 14): rule on [[Designs/arcade/owner-decision-inbox|owner-decision-inbox]] D1–D7 in one sitting, and send the Week-0 outreach (15 creator-permission asks + the js13k organizer email).** Everything else parallelizes to agents; those two acts don't. (FUTO is already submitted, 2026-07-29 — just monitor.)
