...
#status/draft #kind/design #repo/planning #repo/contracts #repo/sdk #topic/content #topic/games #topic/arcade

> **Initial-pass draft:** read the post-pass correction in [[Designs/arcade/README]] before treating any date, game count, client placement, durable seed, faucet, social feature, or outreach item below as a current gate.
