...
#status/draft #kind/design #repo/planning #topic/content #topic/games #topic/arcade

> **Initial-pass draft:** read the post-pass correction in [[Designs/arcade/README]] before using this plan. Its catalog size, Norman-first choice, durable seed, and September gates are not the current implementation baseline.
