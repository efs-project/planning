...
> **Consolidation note — 2026-09-10:** Retained August `EXP-C0` design and
> evidence from [source `2573f08b170bf3eb855ad5a68c31ee7b0215272d`](https://github.com/efs-project/planning/blob/2573f08b170bf3eb855ad5a68c31ee7b0215272d/Designs/efsv2/v2-contract-readiness-program.md).
> This is not the current `MVP-C0` control or a new authority decision. Current
> [[core-architecture-candidate]], [[owner-rulings]], and
> [[Designs/sdkv2/README|SDK v2]] spines take precedence. Prototype runtime and
> evidence remain at the pinned source; historical “current” and gate claims
> below describe that August snapshot, not present readiness.
...
| [`EXP-C0` symbolic semantic seal](https://github.com/efs-project/planning/blob/2573f08b170bf3eb855ad5a68c31ee7b0215272d/Reviews/2026-08-23-efs2-exp-c0-semantic-seal/README.md) | One integrated 61-trace transition/read/authority/query/Lens/reconstruction contract plus declared future minimum comparators and lossless result profiles | Exact disposable bytes/digests, pure-model or Solidity execution, measured bounds, protocol conformance, or a G2 pass |
| [`EXP-C0/v0` exact disposable control](https://github.com/efs-project/planning/blob/2573f08b170bf3eb855ad5a68c31ee7b0215272d/Reviews/2026-08-25-efs2-exp-c0-v0-control/README.md) | One exact candidate data/result/codec handoff, selected JavaScript/Solidity controls, a declared 28-collection projection, and one literal `HELLO_FILES` integration fixture | Complete replay of any of the 61 sealed traces, a live SDK/browser path, protocol adoption, durable bytes, a production Core, or deployment |
...
| [Pinned EIP/ERC screens](https://github.com/efs-project/planning/blob/2573f08b170bf3eb855ad5a68c31ee7b0215272d/Reviews/2026-08-23-efs2-core-eip-erc-pressure/README.md) | Complete official-corpus inventory plus Core/read/Realm/verifier/realization constraints and negative controls | Target-chain activation or support, EFS adoption, exact profiles/bytes, or conformance |
...
[`EXP-C0` semantic trace packet](https://github.com/efs-project/planning/blob/2573f08b170bf3eb855ad5a68c31ee7b0215272d/Reviews/2026-08-23-efs2-exp-c0-semantic-seal/README.md).
The exact disposable C0/v0 data/result/codec profiles and focused executable
controls now exist under [Reviews/2026-08-25-efs2-exp-c0-v0-control/](https://github.com/efs-project/planning/tree/2573f08b170bf3eb855ad5a68c31ee7b0215272d/Reviews/2026-08-25-efs2-exp-c0-v0-control/).
...
- [x] Do the SDK and Data Explorer preserve the exact Core source lock without
  ...
  [cross-lane review](https://github.com/efs-project/planning/blob/2573f08b170bf3eb855ad5a68c31ee7b0215272d/Reviews/2026-08-25-efs2-exp-c0-cross-lane-acceptance/README.md).
