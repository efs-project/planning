...
> **Substrate ruling (2026-07-02):** [[efs-substrate-decision]] adds to this plan: its §7 experiments (a) Class-2 price measurement and (b) envelope rehearsal run during/before Phase 1, (d) the dead-chain fire drill before any year-100 claim enters the Codex; the §8 carrier call (EAS vs native kernel) is decided at the week-3 capacity checkpoint; the §5 mission ruling joins Phase 0.
