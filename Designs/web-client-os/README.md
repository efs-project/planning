...
| [[client-repository-and-development]] | Client-specific initialization input: small workspace/source layout, compilation/import boundaries, pinned SDK/contract artifacts, one-command development, concurrent ports/chains/browser users, process ownership, static/PWA test profiles, CI/releases and human/AI workflow; proposal for Claude's plan review, no creation authorization |
