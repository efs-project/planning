...
**Last touched:** 2026-09-24 — Hegotá/Frames watch delta; other census rows retain their original evidence date
...
| [ERC-7579](https://eips.ethereum.org/EIPS/eip-7579), [ERC-6900](https://eips.ethereum.org/EIPS/eip-6900), [EIP-8130](https://eips.ethereum.org/EIPS/eip-8130), and [EIP-8197](https://eips.ethereum.org/EIPS/eip-8197) | **Draft; watch** | Preserve execution-profile/version/phase/signature-algorithm seams. Do not freeze a public `WriteMechanism` enum around incomplete account/transaction proposals. |
| [EIP-8141](https://eips.ethereum.org/EIPS/eip-8141) | **Draft; scheduled for Hegotá; watch only** | [Draft EIP-8081](https://eips.ethereum.org/EIPS/eip-8081) schedules Frames for the Hegotá upgrade, but its Sepolia, Hoodi and mainnet activation fields were still blank when checked 2026-09-24. Nethermind merged source implementation in [PR #12526](https://github.com/NethermindEth/nethermind/pull/12526) / squash commit [`5246d0c`](https://github.com/NethermindEth/nethermind/commit/5246d0c79940962a277c06268e8fa32ee0dbfb6a), which is implementation evidence—not a released client, activated chain, available wallet path or EFS support. Preserve exact frame/signature/payer/per-frame-result evidence and continue to require canonical EFS effect read-back. `APPROVE` is a protocol instruction, not a human approval or zero-popup guarantee. |
| [EIP-7906](https://eips.ethereum.org/EIPS/eip-7906), [EIP-8250](https://eips.ethereum.org/EIPS/eip-8250), and [EIP-8272](https://eips.ethereum.org/EIPS/eip-8272) | **Draft; considered for Hegotá; watch** | State-diff assertions, keyed nonces and recent-root verification may eventually improve bounded effects, concurrency/replay handling and validation inputs. They do not replace EFS action nonces/stale-plan checks, authority evidence, sponsorship escape, per-effect reconciliation or independent canonical read-back. |
