...
| **[`web-client-os/`](./web-client-os/) — fast Web Client and modular user-owned Web OS** | `planning`, `client`, `sdk` | Active product-layer spine: route-shaped guest boot and generic direct-to-specific-App links with minimum time to qualified data; official basic File Browser writes; `BIOS -> Kernel -> Shell -> Apps`; standards-first Signals/Web Components application foundation with a mandatory pinned modern-Web implementation-evidence gate, reproducible four-catalog Web/ECMAScript/Wasm/WASI index and primary-family review; complete pinned EIP/ERC map for exact reads, explicit wallet/provider selection, signatures, URI/content, contract realization, privacy and agent interoperability; practical SES Worker + LavaMoat/Endo inner-dependency, opaque iframe and Wasm/WIT runner lanes; finite exact-Type consumer adapter with raw-preserving generated codecs and stable UI/agent DTOs; responsive installable/offline/global-use profiles; exact linkable system generations with inert inspection and local activation/rollback; user-replaceable service slots; privacy reserves; and human/agent parity. Core/Files/Type names, route/profile bytes, exact dependencies/module/capability ABI, repository, and implementation remain proposal-only. The July `clientv2/` set is historical evidence. |
| **[`data-explorer/`](./data-explorer/) — guest-first typed EFS Data Explorer** | `planning`, `client`, `sdk` | Owner-directed product lane for the primary general-purpose EFS data application: desktop-grade Files navigation plus qualified table/card/gallery/timeline/graph/raw/provenance views over any accepted typed resource. The next disposable pressure slice consumes sealed `EXP-C0/v0`: direct guest route → exact bootstrap/basis → Type/Record/Occurrence → verified byte attempts → raw/provenance Inspector, preserving literal `ResultV0` axes and fully bound opaque cursor commitments. Tree/list/grid/table and capability-limited extension seams remain modular and do not block that slice. No product repository, implementation, view/query/plugin ABI or protocol bytes are adopted; a read-only slice still waits on E0/E1a/E1b/E2/E3/E4. |
...
| Repo | Designs |
|---|---|
| `planning` | [[0001-design-system]], [[cross-repo-reference-mirror]], [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`web-client-os/`](./web-client-os/), [`data-explorer/`](./data-explorer/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
...
| `client` | [`web-client-os/`](./web-client-os/), [`data-explorer/`](./data-explorer/), [`clientv2/`](./clientv2/), [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
| `sdk` | [`web-client-os/`](./web-client-os/), [`data-explorer/`](./data-explorer/), [`clientv2/`](./clientv2/), [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
