...
| **[`sdkv2/`](./sdkv2/) — contracted EFS v2 SDK seam** | `planning`, `sdk`, `client` | MVP-C0 consumer contract with exactly five semantic seams: exact read, scoped page read, verified byte read, plan/authorize/submit, and canonical read-back. Generated conveniences retain raw canonical bytes and every imported qualification axis. No package, ABI, implementation, or permanent profile is authorized. |
| **[`web-client-os/`](./web-client-os/) — fast Web Client and modular user-owned Web OS** | `planning`, `client`, `sdk` | Active product-layer spine with a bounded [[web-client-os/mvp0-acceptance|MVP0 overlay]] for the first thin File Browser journey. Route-shaped guest reads remain wallet/OS/Data-Explorer independent; folder/file/revision writes use the shared SDK seams and succeed only after canonical read-back. The 929-line acceptance document remains a broader roadmap/freeze catalog; Core/Files/Type names, route/profile bytes, dependencies, repository, and implementation remain proposal-only. The July `clientv2/` set is historical evidence. |
| **[`data-explorer/`](./data-explorer/) — general EFS typed-data workspace** | `planning`, `client`, `sdk` | Concise product spine for an Inspector/view consumer over the shared Reader/action contract. It may later add table/card/gallery/graph views, but it is neither an exact File Browser route gateway nor a second write stack, and its packaging is outside MVP0. |
...
| Repo | Designs |
|---|---|
| `planning` | [[0001-design-system]], [[cross-repo-reference-mirror]], [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`sdkv2/`](./sdkv2/), [`web-client-os/`](./web-client-os/), [`data-explorer/`](./data-explorer/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
...
| `client` | [`web-client-os/`](./web-client-os/), [`data-explorer/`](./data-explorer/), [`clientv2/`](./clientv2/), [`sdkv2/`](./sdkv2/), [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
| `sdk` | [`sdkv2/`](./sdkv2/), [`web-client-os/`](./web-client-os/), [`data-explorer/`](./data-explorer/), [`clientv2/`](./clientv2/), [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
