...
| **[`sdkv2/`](./sdkv2/) — EFS v2 offchain and onchain SDK experience** | `planning`, `sdk`, `contracts`, `client` | Founder-authorized draft spine for a raw-preserving offchain runtime, exact generated TypeScript and Solidity façades, compatibility/result/security policy, and a proposed evidence-gated experiment program after first-pass review. No bytes, package names, ABI, helper deployment, experiment execution, or production implementation is adopted. |
