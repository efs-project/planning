...
| **[`sdkv2/`](./sdkv2/) — EFS v2 offchain and onchain SDK experience** | `planning`, `sdk`, `contracts`, `client` | Founder-authorized draft spine for a raw-preserving offchain runtime, exact generated TypeScript and Solidity façades, compatibility/result/security policy, a dated modern Ethereum standards/profile census, and a proposed evidence-gated experiment program after first-pass review. No bytes, package names, ABI, helper deployment, experiment execution, or production implementation is adopted. |
...
| Repo | Designs |
|---|---|
| `planning` | [[0001-design-system]], [[cross-repo-reference-mirror]], [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`sdkv2/`](./sdkv2/), [`web-client-os/`](./web-client-os/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
| `contracts` | [[cross-repo-reference-mirror]], [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`sdkv2/`](./sdkv2/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
| `client` | [`web-client-os/`](./web-client-os/), [`clientv2/`](./clientv2/), [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`sdkv2/`](./sdkv2/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
| `sdk` | [`web-client-os/`](./web-client-os/), [`clientv2/`](./clientv2/), [`efs15/`](./efs15/), [`efsv2/`](./efsv2/), [`sdkv2/`](./sdkv2/), [`open-web-app-store/`](./open-web-app-store/), [`media-library/`](./media-library/) |
