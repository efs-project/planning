...
**0. ⚠️ Lists status?** T-2 days to OnionDAO. Custom-lists branch has had ZERO pushed commits in 3 days; In Flight card expired 2026-05-29. PM has no visibility into reality. Pick one (a 1-line note is enough):
- (a) Working locally, will push by `<date>`
- (b) Stalled on `<what>` — need help
- (c) Slipping past 2026-06-01 — let's replan OnionDAO scope (e.g., flyer-up + data-add ships post-Lists; soft-launch the contracts-direct path)
- (d) Other — tell me
