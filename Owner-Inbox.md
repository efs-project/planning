...
- **EFS v2 authority/identity packet is ready** — Fable's joined pass delivered P-1…P-23; the hold is liftable for P-1…P-10, while lens-coupled items remain held. See [Open-Decisions.md](./Open-Decisions.md).
